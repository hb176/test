package com.gmp.workflow.exception;
...
public class FlowException extends RuntimeException {
    ...
    public FlowException() { super(); }

    public FlowException(String message, Throwable throwable) { super(message, throwable); }

    public FlowException(String message) { super(message); }

    public FlowException(Throwable throwable) { super(throwable); }
